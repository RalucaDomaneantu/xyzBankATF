...
public class CustomersPage extends BasePage{
    ...
    public void validateCustomer(CustomerModel testData ){
        ...
        LogUtility.infoLog("The user fills last name field with value: " + testData.getLastNameValue() + "into the table");

        Assert.assertTrue(customerTableRow.contains(testData.getPostCodeValue()));
        LogUtility.infoLog("The user fills last name field with value: " + testData.getPostCodeValue() + "into the table");
